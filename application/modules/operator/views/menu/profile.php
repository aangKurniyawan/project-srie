...
<head>
  ...
  <title>Laundry | User Profile</title>
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url();?>assets_operator/dist/img/user4-128x128.jpg" alt="User profile picture">
