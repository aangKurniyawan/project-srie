			...
			<div class="w3_agile_services_grids">
				...
				<div class="col-md-4 w3_agile_services_grid">
					<div class="agile_services_grid">
						<div class="hover06 column">
							<div>
								<figure><img src="<?php echo base_url();?>assets_member/images/a1.jpg" alt=" " class="img-responsive" /></figure>
							</div>
						</div>
					...
					<p class="para-w3-agile">Suspendisse dapibus felis mauris, id efficitur lacus tincidunt id.</p>
				</div>
				<div class="col-md-4 w3_agile_services_grid">
					<div class="agile_services_grid">
						<div class="hover06 column">
							<div>
								<figure><img src="<?php echo base_url();?>assets_member/images/a3.jpg" alt=" " class="img-responsive" /></figure>
							</div>
						</div>
						<div class="agile_services_grid_pos">
				...
				<div class="col-md-4 w3_agile_services_grid">
					<div class="agile_services_grid">
						<div class="hover06 column">
							<div>
								<figure><img src="<?php echo base_url();?>assets_member/images/a2.jpg" alt=" " class="img-responsive" /></figure>
							</div>
						</div>
						<div class="agile_services_grid_pos">
				...
				<div class="col-md-6 w3_agile_services_grid">
					<div class="agile_services_grid">
						<div class="hover06 column">
							<div>
								<figure><img src="<?php echo base_url();?>assets_member/images/a4.jpg" alt=" " class="img-responsive" /></figure>
							</div>
						</div>
						<div class="agile_services_grid_pos">
					...
					<p class="para-w3-agile">Duis libero mi, accumsan eu elementum in, tempus quis tortor. Mauris a iaculis dolor. Nunc sagittis, metus vitae blandit fermentum</p>
				</div>
				<div class="col-md-6 w3_agile_services_grid">
					<div class="agile_services_grid">
						<div class="hover06 column">
							<div>
								<figure><img src="<?php echo base_url();?>assets_member/images/a5.jpg" alt=" " class="img-responsive" /></figure>
							</div>
						</div>
						<div class="agile_services_grid_pos">
